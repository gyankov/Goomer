...
{
    [TestFixture]
    public class SearchingNexFive_Should
    {
        [Test]
        public void CallRimsServiceGetNextFiveMethod()
        {
            ...
            //Act
            var result = controller.SearchingNextFive(It.IsAny<TiresSearchModel>(), It.IsAny<int>());

            //Assert
            mockedRimsService.Verify(x => x.GetNextFive(It.IsAny<TiresSearchModel>(), It.IsAny<int>()), Times.Once);
        }
